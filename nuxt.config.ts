...
export default defineNuxtConfig({
  ...
  modules: ['@vueuse/nuxt', '@nuxtjs/tailwindcss', '@nuxtjs/supabase', '@nuxt/image', 'nuxt-icon', 'nuxt-lodash', '@nuxtjs/device', '@morev/vue-transitions/nuxt', ['@pinia/nuxt', { autoImports: ['defineStore', 'acceptHMRUpdate'] }], '@pinia-plugin-persistedstate/nuxt', 'nuxt-umami'],
  supabase: {
