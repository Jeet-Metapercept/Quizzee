    ...
    <div class="flex items-center justify-center h-full">
      <div class="text-center">
        ...
        <div v-else>
          ...
          </label><label for="waiting-for-result" class="text-muted-foreground block text-sm font-normal leading-6">Hold tight - we're preparing your score card.. Almost there!</label>
        </div>
      </div>
    </div>
  </div>
